...
import type { StudioBlockInstance, StudioBlockDefinition } from '../../types/studio'
...
export const PropsPanel = ({ block, definition, onChange }: PropsPanelProps) => {
	if (!block || !definition) {
		return (
			<div className="studio-inspector">
				<div className="studio-inspector-empty">Select a block to edit its properties</div>
			</div>
		)
	}
