    ...
    callWithErrorHandling(appWarnHandler, instance, 11, [
      msg +
        args
          .map((a) => {
            var _a, _b;
            return (_b = (_a = a.toString) == null ? undefined : _a.call(a)) !=
              null
              ? _b
              : JSON.stringify(a);
          })
...
function setDevtoolsHook$1(hook, target) {
  ...
  if (devtools$1) {
    ...
    typeof window !== "undefined" &&
    window.HTMLElement &&
    !((_b = (_a = window.navigator) == null ? undefined : _a.userAgent) == null
      ? undefined
      : _b.includes("jsdom"))
  ) {
...
// src/frontend/vue/client/composables/useCount.js
var useCount = (initialCount) => {
...
// src/frontend/vue/client/components/CountButton.js
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  return (
    ...
    createElementBlock(
      ...
      "count is " + toDisplayString($setup.count),
      1,
    )
  );
}
...
var CountButton_default = script;

// src/frontend/vue/client/pages/VueExample.js
var script2 = defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const __returned__ = {
      ...
      openDropdown,
      closeDropdown,
      CountButton: CountButton_default,
    };
    Object.defineProperty(__returned__, "__isScriptSetup", {
      enumerable: false,
      value: true,
    ...
    createElementBlock(
      ...
      [
        createBaseVNode("header", null, [
          _cache[1] ||
            (_cache[1] = createBaseVNode("a", { href: "/" }, "AbsoluteJS", -1)),
          createBaseVNode(
            "details",
            {
              ref: "dropdown",
              onPointerenter: $setup.openDropdown,
              onPointerleave: $setup.closeDropdown,
            },
            [
              ...(_cache[0] ||
                (_cache[0] = [
                  createStaticVNode(
                    '<summary data-v-vue-example>Pages</summary><nav data-v-vue-example><a href="/react" data-v-vue-example>React</a><a href="/html" data-v-vue-example>HTML</a><a href="/svelte" data-v-vue-example>Svelte</a><a href="/vue" data-v-vue-example>Vue</a><a href="/htmx" data-v-vue-example>HTMX</a><a href="/angular" data-v-vue-example>Angular</a></nav>',
                    2,
                  ),
                ])),
            ],
        ...
        createBaseVNode("main", null, [
          ...
          _cache[3] ||
            (_cache[3] = createBaseVNode("h1", null, "AbsoluteJS + Vue", -1)),
          createVNode(
            $setup["CountButton"],
            ...
            (_cache[4] = createBaseVNode(
              ...
              [
                ...
                createBaseVNode(
                  "code",
                  null,
                  "src/frontend/vue/pages/VueExample.vue",
                ),
                createTextVNode(" and save to test HMR. "),
              ],
              -1,
            )),
          _cache[5] ||
...
script2.__scopeId = "data-v-vue-example";
script2.__hmrId = "pages/VueExample";
if (typeof __VUE_HMR_RUNTIME__ !== "undefined") {
  __VUE_HMR_RUNTIME__.createRecord(script2.__hmrId, script2);
  if (typeof window !== "undefined") {
    window.__VUE_HMR_COMPONENTS__ = window.__VUE_HMR_COMPONENTS__ || {};
    window.__VUE_HMR_COMPONENTS__[script2.__hmrId] = script2;
  }
}
var VueExample_default = script2;
...
var runWithViewTransition = (updateFn) => {
  const doc2 = document;
  if (typeof doc2.startViewTransition !== "function") {
    updateFn().catch((err) => {
...
var replaceInlineScript = (script3) => {
  if (script3.hasAttribute("data-hmr-client")) {
    return;
  }
  const newScript = document.createElement("script");
  newScript.textContent = script3.textContent || "";
  const scriptEl = script3 instanceof HTMLScriptElement ? script3 : null;
  newScript.type = scriptEl?.type || "text/javascript";
  if (script3.parentNode) {
    script3.parentNode.replaceChild(newScript, script3);
  }
};
...
var collectScripts = (container) =>
  Array.from(container.querySelectorAll("script[src]")).map((script3) => ({
    src: script3.getAttribute("src") || "",
    type: script3.getAttribute("type") || "text/javascript",
  }));
var collectScriptsFromElement = (elem) =>
  Array.from(elem.querySelectorAll("script[src]")).map((script3) => ({
    src: script3.getAttribute("src") || "",
    type: script3.getAttribute("type") || "text/javascript",
  }));
...
var removeOldScripts = (container) => {
  ...
  scriptsInNewHTML.forEach((script3) => {
    if (!script3.hasAttribute("data-hmr-client")) {
      script3.remove();
    }
  });
...
var replaceInlineScript2 = (script3) => {
  if (script3.hasAttribute("data-hmr-client")) {
    return;
  }
  const newScript = document.createElement("script");
  newScript.textContent = script3.textContent || "";
  newScript.type = script3.getAttribute("type") || "text/javascript";
  if (script3.parentNode) {
    script3.parentNode.replaceChild(newScript, script3);
  }
};
...
// src/frontend/vue/indexes/VueExample.js
...
if (
  typeof window !== "undefined" &&
  Object.keys(preservedState).length === 0 &&
  sessionStorage.getItem("__HMR_ACTIVE__")
) {
  try {
...
var isHMR =
  typeof window !== "undefined" && sessionStorage.getItem("__HMR_ACTIVE__");
var app = isHMR
  ? createApp(VueExample_default, mergedProps)
  : createSSRApp(VueExample_default, mergedProps);
app.mount("#root");
if (typeof window !== "undefined") {
...
function applyPreservedState(instance, state) {
  if (instance.setupState) {
    Object.keys(state).forEach(function (key) {
      const ref2 = instance.setupState[key];
      if (ref2 && typeof ref2 === "object" && "value" in ref2) {
        ref2.value = state[key];
      }
    });
  }
  if (instance.subTree) {
...
function walkAndApply(vnode, state) {
  ...
  if (vnode.component && vnode.component.setupState) {
    Object.keys(state).forEach(function (key) {
      const ref2 = vnode.component.setupState[key];
      if (ref2 && typeof ref2 === "object" && "value" in ref2) {
        ref2.value = state[key];
      }
    });
