...
// src/frontend/react/indexes/NewReact2.tsx
...
var _s = $RefreshSig$();
_s(NewReact2, "MY+OAOgvYPI=");
$RefreshReg$(NewReact2, "src/frontend/react/pages/NewReact2.tsx:NewReact2");

// src/frontend/react/indexes/NewReact2.tsx
window.__HMR_FRAMEWORK__ = "react";
window.__REACT_COMPONENT_KEY__ = "NewReact2Index";
...
var isDev = true;
var componentPath = "../pages/NewReact2";
...
function handleHydrationFallback(error) {
  ...
  logHydrationError(error, "NewReact2");
  try {
    if (
    ...
    root.render(
      createElement(ErrorBoundary, null, createElement(NewReact2, mergedProps)),
    );
