...
$RefreshReg$(Test, "src/frontend/pages/Test.tsx:Test");

// src/frontend/indexes/Test.tsx
window.__HMR_FRAMEWORK__ = "react";
window.__REACT_COMPONENT_KEY__ = "TestIndex";
...
function handleHydrationFallback(error) {
  ...
  try {
    ...
    root.render(
      createElement(ErrorBoundary, null, createElement(Test, mergedProps)),
    );
