...
$RefreshReg$(New, "src/frontend/pages/New.tsx:New");

// src/frontend/indexes/New.tsx
window.__HMR_FRAMEWORK__ = "react";
window.__REACT_COMPONENT_KEY__ = "NewIndex";
...
function handleHydrationFallback(error) {
  ...
  try {
    ...
    root.render(
      createElement(ErrorBoundary, null, createElement(New, mergedProps)),
    );
